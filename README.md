...
The second, third and fourth OLS regression model evaluate the effect of IMDb score, Metascore and Gross Revenue generated respectively on the different genres of movies in our database. In the IMDb model, a total of 11 genres out of the 20 genres we have accounted for are statistically significant, whereas for the Metascore model, a total of 12 genres are statistically significant. The “sport” variable is the difference between these two models in terms of statistical significance. The gross revenue model yields a statistically significant coefficient with respect to IMDb, Metascore and the Release Year, which shows the accuracy of this model and consistency with our previous findings. However, it is hard to evaluate the statistical significance of gross revenue on one movie, since one movie can encompass several genres that might/might not be statistically significant in this model.
